            ...
            <div className="mt-5 flex gap-3">
              {SOCIALS.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.name}
                  className="w-8 h-8 rounded-full glass flex items-center justify-center text-slate-400 hover:text-white hover:border-cyan-500/30 transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
